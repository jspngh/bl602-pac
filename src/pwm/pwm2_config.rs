...
pub type R = crate::R<Pwm2ConfigSpec>;
#[doc = "Register `pwm2_config` writer"]
pub type W = crate::W<Pwm2ConfigSpec>;
...
impl W {
    #[doc = "Bits 0:1"]
    #[inline(always)]
    pub fn reg_clk_sel(&mut self) -> RegClkSelW<'_, Pwm2ConfigSpec> {
        RegClkSelW::new(self, 0)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn pwm_out_inv(&mut self) -> PwmOutInvW<'_, Pwm2ConfigSpec> {
        PwmOutInvW::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn pwm_stop_mode(&mut self) -> PwmStopModeW<'_, Pwm2ConfigSpec> {
        PwmStopModeW::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn pwm_sw_force_val(&mut self) -> PwmSwForceValW<'_, Pwm2ConfigSpec> {
        PwmSwForceValW::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn pwm_sw_mode(&mut self) -> PwmSwModeW<'_, Pwm2ConfigSpec> {
        PwmSwModeW::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    pub fn pwm_stop_en(&mut self) -> PwmStopEnW<'_, Pwm2ConfigSpec> {
        PwmStopEnW::new(self, 6)
    }
}
#[doc = "pwm2_config.\n\nYou can [`read`](crate::Reg::read) this register and get [`pwm2_config::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pwm2_config::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pwm2ConfigSpec;
impl crate::RegisterSpec for Pwm2ConfigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm2_config::R`](R) reader structure"]
impl crate::Readable for Pwm2ConfigSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm2_config::W`](W) writer structure"]
impl crate::Writable for Pwm2ConfigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets pwm2_config to value 0x08"]
impl crate::Resettable for Pwm2ConfigSpec {
